    ...
    <div class="order-caption">
        ...
        <div class="card-container">
            <div class="card">
                ...
                <h4 class="card-title">Title 1</h3>
                <div class="card-text">text</div>
            </div>
            <div class="card">
                <div class="card-img">
                <img src="images/6798.jpg" alt="" class="img-img">
                </div>
                <h4 class="card-title">Title 2</h3>
                <div class="card-text">text</div>
            </div>
            <div class="card">
                <div class="card-img">
                    <img src="images/6471.jpg" alt="" class="img-img">
                </div>
                <h4 class="card-title">Title 3.1</h3>
                <div class="card-text">text</div>
            </div>
        </div>
    </section>